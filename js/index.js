...
var ACTIVE_SLIDE_CSS_CLASS = 'slide_active';
var ACTIVE_PAGER_ITEM_CSS_CLASS = 'pager__item_active';
...
var Carousel = function () {
     ...
     * */
    function Carousel(cssSelector, configs) {
    ...
    _createClass(Carousel, [{
        ...
        value: function wrapContent() {
            this.slides.wrapAll($('<div class="carousel__slides"></div>'));
        }
    }, {
        key: 'renderControls',
        value: function renderControls() {
            var controlsWrapper = $('<div class="slider__controls"></div>');

            this.controlNext = $('<button class="control-next control">next</button>');
            this.controlPrev = $('<button class="control-prev control">prev</button>');
        ...
        value: function renderPager() {
            ...
            this.pagerItems = [];
            var pagerWrapper = $('<ul>').addClass('carousel__pager pager');

            $.each(this.slides, function (i) {
                var pagerItem = $('<li class="pager__item"> ');

                if (_this.activeSlideIndex === i) {
                    pagerItem.addClass(ACTIVE_PAGER_ITEM_CSS_CLASS);
                }

                pagerItem.on('click', function () {
                    _this.activeSlideIndex = i;
                    _this.switchSlide();
                });

                _this.pagerItems.push(pagerItem);
        ...
        key: 'enableSlide',
        value: function enableSlide() {
            var slide = this.slides[this.activeSlideIndex];
            if (slide === undefined) {
        ...
        key: 'switchPager',
        value: function switchPager() {
            var currentPagerItem = this.pagerItems[this.activeSlideIndex];
        ...
        key: 'increaseSlideIndex',
        value: function increaseSlideIndex() {
        ...
        key: 'decreaseSlideIndex',
        value: function decreaseSlideIndex() {
        ...
        value: function handleEvents() {
            ...
            this.controlNext.on('click', function () {
                _this2.increaseSlideIndex();
                _this2.switchSlide();
            });
            this.controlPrev.on('click', function () {
                _this2.decreaseSlideIndex();
                _this2.switchSlide();
            });
        }
    }]);
